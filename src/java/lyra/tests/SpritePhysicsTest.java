/*
 * SpritePhysicsTest.java
 *
 * Copyright (C) 2007 - 2008 by Joshua S. English. This document is the
 * intellectual property of Joshua S. English. All rights reserved.
 *
 * A simple extension of the GameEngine to test Sprite Physics.
 *
...
public class SpritePhysicsTest extends GameEngine
{
	// define private class constants

	private static final String CLASS_NAME = SpritePhysicsTest.class.getName();
	...
	public synchronized void pipeline()
	{
		...
		drawString("ENGINE keyboard (" + lastBinaryKeyPress +
				...
				keyPressBuffer + "'", 0, 44);
		drawString("SpritePhysics, (" + physics.getXSpeed() + ", " +
				physics.getYSpeed() + "): " + physics.getRate() + ", turbo: " +
				physics.isUsingTurbo(), 0, 60);
	}
